        ...
        <div className="container">
          <div className="intro">
            ...
            <div className="intro-text left-0 text-center bg-faded p-5 rounded">
              ...
              <p className="mb-3">
                If you need assistance with removing a bee hive or swarm near
                your home - we can help. Get in touch today about our bee
                removal and relocation services. You'll bee happy that you did!
              </p>
          ...
          <div className="product-item">
            <div className="product-item-title d-flex">
              <div className="bg-faded p-5 d-flex ml-auto rounded">
                <h2 className="section-heading mb-0">
                  <span className="section-heading-upper">Humane & Gentle</span>
                  <span className="section-heading-lower">Relocation</span>
                </h2>
              </div>
            </div>
            <img
            ...
            <div className="product-item-description d-flex mr-auto">
              <div className="bg-faded p-5 rounded">
                <p className="mb-0">
                  Bees are not pests. Occasionally bees can set up homes in
                  areas that are inconvenient to humans. Our approach is a
                  gentle relocation that provides bees a new home where they can
                  pollinate gardens, produce honey and live happily ever after.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-xl-9 mx-auto">
              <div className="cta-inner text-center rounded">
                ...
                <p className="mb-0">
                  ...
                  Bees are an essential part of our agriculture, and their
                  health directly impacts food security.
                </p>
        ...
        <div className="container">
          <div className="product-item">
            ...
            <div className="product-item-description d-flex ml-auto">
              <div className="bg-faded p-5 rounded">
                <p className="mb-0">
                  Get beekeeping advice and education from a pleasant
